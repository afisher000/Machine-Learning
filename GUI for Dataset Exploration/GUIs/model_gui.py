...
from Utils.pipelines import FeatureTransforms, Imputation, Scaling, KeepSelectedFeatures
from Utils.models import ModelAnalysis
from sklearn.pipeline import Pipeline
from sklearn.preprocessing import PolynomialFeatures

from GUIs.figure_gui import GUI_Figure
import pandas as pd
import numpy as np
import os
import numbers
...
mw_Ui, mw_Base = uic.loadUiType('UIs/model_analysis_gui.ui')
class ModelGUI(mw_Base, mw_Ui):
    ...
    def initialize_model(self):
        ...
        # Trying to solve import problem
